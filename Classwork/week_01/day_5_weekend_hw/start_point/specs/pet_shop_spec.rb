...
#20
  ...
  def test_sell_pet_to_customer__pet_found
    customer = @customers[0]
    pet = find_pet_by_name(@pet_shop,"Arthur")      #10

    sell_pet_to_customer(@pet_shop, pet, customer)  #20

    assert_equal(1, customer_pet_count(customer))   #16
    assert_equal(1, pets_sold(@pet_shop))           #5
    assert_equal(100, customer_cash(customer))      #14
    assert_equal(1900, total_cash(@pet_shop))       #2
  end
